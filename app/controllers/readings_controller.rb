class ReadingsController < ApplicationController
  ...
  # GET /readings.json
  def index
    @readings = Reading.order(created_at: :desc).limit(30)
    @reading = Reading.order(created_at: :desc).last
  end
  ...
  private
    ...
    def reading_params
      params.require(:reading).permit(:air_temperature, :water_temperature, :humidity, :total_dissolved_solids, :ph_level)
    end
end
